...
const ArrowPolygon = ({
  ...
  if (Math.abs(arrowX) * Math.abs(arrowY) === 2) {
    ...
    var points = [
      ...
      `${(fromCol + 0.5 - SHAFT_WIDTH/2) * 12.5},${(fromRow + 0.5 + SPACE_BETWEEN_ORIGIN) * 12.5}`,
      `${(fromCol + 0.5 + SHAFT_WIDTH/2) * 12.5},${(fromRow + 0.5 + SPACE_BETWEEN_ORIGIN) * 12.5}`,
      `${(fromCol + 0.5 + SHAFT_WIDTH/2) * 12.5},${(fromRow + 2.5 - SHAFT_WIDTH/2) * 12.5}`,
      `${(fromCol + 1.5 - HEAD_HEIGHT) * 12.5},${(fromRow + 2.5 - SHAFT_WIDTH/2) * 12.5}`,
      `${(fromCol + 1.5 - HEAD_HEIGHT) * 12.5},${(fromRow + 2.5 - HEAD_WIDTH/2) * 12.5}`,
    ...
    const scale = (theta % 90) > 63
      ? '1,1'
      : '-1,1';
    const translate = scale === '1,1'
      ? '0'
      : `-${2 * (12.5 * fromCol) + 12.5}`;
    ...
    var points = [
      ...
      `${(fromCol + 0.5 - HEAD_WIDTH/2) * 12.5},${(fromRow + distance + 0.5 - HEAD_HEIGHT) * 12.5}`,
      `${(fromCol + 0.5 - SHAFT_WIDTH/2) * 12.5},${(fromRow + distance + 0.5 - HEAD_HEIGHT) * 12.5}`,
      `${(fromCol + 0.5 - SHAFT_WIDTH/2) * 12.5},${(fromRow + 0.5 + SPACE_BETWEEN_ORIGIN) * 12.5}`,
      `${(fromCol + 0.5 + SHAFT_WIDTH/2) * 12.5},${(fromRow + 0.5 + SPACE_BETWEEN_ORIGIN) * 12.5}`,
      `${(fromCol + 0.5 + SHAFT_WIDTH/2) * 12.5},${(fromRow + distance + 0.5 - HEAD_HEIGHT) * 12.5}`,
      `${(fromCol + 0.5 + HEAD_WIDTH/2) * 12.5},${(fromRow + distance + 0.5 - HEAD_HEIGHT) * 12.5}`,
